...
export declare function getFileViewUrl(cloud_storage_path: string, isPublic: boolean): Promise<string>;
export declare function getFileBuffer(cloud_storage_path: string): Promise<Buffer>;
